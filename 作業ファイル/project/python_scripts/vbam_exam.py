...
_COMPANY = ['アクアテック', '北斗精機', 'みらい物流', 'サンライズ食品', '東雲建設', 'ひかり電工', '大森商事',
            'グリーンファーム', 'はやて運輸', '秋桜印刷', 'ミナト化成', 'こまち製菓', '白神ソフト', '鳥海テクノ',
            '雄物川工業', 'ブルーオーシャン', '森の木工房', 'ユニバース通信', 'タカノ機械', '花園フーズ', 'ステラ設計',
            '稲穂農産', 'コスモ薬品', 'やまびこ観光', '銀河システム', 'しらかば住建', 'ノーザン電子', '朝日ビルメン',
            '若葉介護', '港町水産', '千秋エンジニアリング', 'オーロラ化学', '田沢湖リゾート', '八幡平ファーム',
            'かもしか工芸', '十和田電設', '日本海マリン', '竿燈企画', 'なまはげ製作所', '奥羽テック', 'きりたんぽ本舗',
            '横手精密', '湯沢メディカル', '男鹿ネット', '角館ホールディングス']
...
_PAYEES = ['JR東日本', '秋田中央交通', 'タクシー北都', 'ホテル千秋', '文具のヤマダ', 'Amazon', 'NTTドコモ', '喫茶こまち']
